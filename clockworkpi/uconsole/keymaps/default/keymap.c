...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LY2] = LAYOUT(
        ...
        JS_4,    JS_5,    _______, _______, JS_7,    JS_6,    _______, _______,
        _______, _______, _______, _______, _______, _______, JS_9,    JS_10,
        _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, JS_8,    _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______
